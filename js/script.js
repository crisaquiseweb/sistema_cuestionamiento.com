document.addEventListener('DOMContentLoaded', function() {
    ...
    sendButton.addEventListener('click', function() {
        const message = userInput.value.trim().toLowerCase(); // Convertir a minúsculas para comparar más fácilmente
        if (message) {
            ...
            if (message.includes('hola') || message.includes('ayuda')) {
                ...
                setTimeout(function() {
                    addBotMessage("Para iniciar sesión, ingresa tu nombre de usuario en el campo correspondiente y haz clic en el botón 'Ingresar'. Si olvidaste tu contraseña, puedes generar una nueva.");
                }, 1000);
